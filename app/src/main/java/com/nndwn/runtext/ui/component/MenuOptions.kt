...
enum class MenuOptions(@param:StringRes val label: Int, @param:DrawableRes val iconRes: Int) {
  SUPPORT(label = R.string.menu_support, iconRes = R.drawable.ic_coffee2),
...
@Composable
private fun ItemOptions(menu: MenuOptions, modifier: Modifier = Modifier, onClick: () -> Unit = {}) {
  Row(
    modifier =
      modifier
        .fillMaxWidth()
