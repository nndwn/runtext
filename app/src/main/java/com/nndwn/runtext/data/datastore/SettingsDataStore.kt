    ...
    dataStore.data
      ...
      .map { prefs ->
        ...
        AppSettings(
          ...
          mode =
            prefs[MODE]?.let { name -> runCatching { AppMode.valueOf(name) }.getOrDefault(default.mode) }
              ?: default.mode,
          textConfig =
            TextConfig(
              ...
              textStyle =
                TextStyleConfig(
                  colorArgb = prefs[TEXT_COLOR] ?: default.textConfig.textStyle.colorArgb,
                  colorType =
                    prefs[TEXT_COLOR_TYPE]?.let { name ->
                  ...
                  gradientColorsArgb =
                    prefs[GRADIENT_COLORS]?.let { str ->
                      str.split(",").mapNotNull { it.toLongOrNull() }.ifEmpty { null }
                    } ?: default.textConfig.textStyle.gradientColorsArgb,
                  gradientDistance = prefs[GRADIENT_DISTANCE] ?: default.textConfig.textStyle.gradientDistance,
                  isGradientHorizontal = prefs[GRADIENT_POSITION] ?: default.textConfig.textStyle.isGradientHorizontal,
                  fontType =
                    prefs[FONT_TYPE]?.let { name ->
                  ...
                  googleFontName = prefs[GOOGLE_FONT_NAME] ?: default.textConfig.textStyle.googleFontName,
                  letterSpacingSp = prefs[LETTER_SPACING] ?: default.textConfig.textStyle.letterSpacingSp,
                  wordSpacingSp = prefs[WORD_SPACING] ?: default.textConfig.textStyle.wordSpacingSp,
                ),
              stroke =
                StrokeConfig(
                  isEnabled = prefs[IS_STROKE_ENABLED] ?: default.textConfig.stroke.isEnabled,
                  width = prefs[STROKE_WIDTH] ?: default.textConfig.stroke.width,
                  colorArgb = prefs[STROKE_COLOR] ?: default.textConfig.stroke.colorArgb,
                ),
              shadow =
                ShadowConfig(
                  isEnabled = prefs[IS_SHADOW_ENABLED] ?: default.textConfig.shadow.isEnabled,
          ...
          morseConfig =
            MorseConfig(
              ...
              isTorchEnabled = prefs[TORCH_ENABLED] ?: default.morseConfig.isTorchEnabled,
              bgColorMorse = prefs[MORSE_BG_COLOR] ?: default.morseConfig.bgColorMorse,
              isSoundEnabled = prefs[IS_SOUND_ENABLED] ?: default.morseConfig.isSoundEnabled,
              isVibrateEnabled = prefs[IS_VIBRATE_ENABLED] ?: default.morseConfig.isVibrateEnabled,
            ),
        )
      }
