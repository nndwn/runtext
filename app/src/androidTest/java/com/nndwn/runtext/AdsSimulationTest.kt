...
class SupportDialogSimulationTest {

  @get:Rule val composeTestRule = createAndroidComposeRule<MainActivity>()

  @Test
  fun testSupportDialogAppearsAfterForcingInDebug() {
    // 1. Open Sidebar
    ...
    // 3. Force Show Support Dialog
    composeTestRule.onNodeWithText("Force Show Support Dialog (Reset Timer)").performClick()
    ...
    // 6. Verify Support Dialog is displayed
